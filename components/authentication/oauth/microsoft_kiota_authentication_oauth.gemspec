...
Gem::Specification.new do |spec|
  ...
  spec.metadata      = {
    ...
    'changelog_uri'   => 'https://github.com/microsoft/kiota-ruby/blob/main/components/authentication/oauth/CHANGELOG.md',
  ...
  spec.add_runtime_dependency 'microsoft_kiota_abstractions', '>= 0.17', '< 0.18'
